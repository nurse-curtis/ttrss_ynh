...
``` bash
sudo yunohost app install https://github.com/nurse-curtis/ttrss_ynh/tree/testing --debug
or
sudo yunohost app upgrade ttrss -u https://github.com/nurse-curtis/ttrss_ynh/tree/testing --debug
```
